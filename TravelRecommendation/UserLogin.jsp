			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active"><a href="UserLogin.jsp"><b>User</b></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-lg-12">
							...
							<br>
							<p>If you are new user <a href="UserRegistration.jsp" style="color:red"> click Here ?</a></p>
							</div>
						</div>
						<div class="col-sm-offset-4 col-lg-6 ">
							<form  id="contactForm" action="UserLoginController" method="post" >
								<div class="row">
									...
									<div>
										<a href="UserForgotPassword.jsp" style="color:red" >Forgot Password ?</a>
									</div>
